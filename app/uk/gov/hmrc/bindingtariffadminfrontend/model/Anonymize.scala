...
object Anonymize {
  ...
  private def anonymizeEBTIApplication(data: Map[String, String]): Map[String, String] = data.map {
    ...
    case (k @ "PreviousNomenclatureCode", _) => (k, faker.idNumber().valid())
    case (k @ "EnvisagedNomenclature", _) => (k, faker.lorem().characters(22))
    ...
    case (k @ "OtherNomenclatureCode1", _) => (k, faker.lorem().characters(22))
    ...
    case (k @ "OtherNomenclatureCode2", _) => (k, faker.lorem().characters(22))
    ...
    case (k @ "HolderOtherNomenclatureCode1", _) => (k, faker.lorem().characters(22))
    ...
    case (k @ "HolderOtherNomenclatureCode2", _) => (k, faker.lorem().characters(22))
    ...
    case (k @ "OtherNomenclature", _) => (k, faker.lorem().characters(22))
    case other => other
  }
  ...
  private def anonymizeTblCaseRecord(data: Map[String, String]): Map[String, String] = data.map {
    ...
    case (k @ "ApplicationRef", _) => (k, faker.idNumber().valid())
    ...
    case (k @ "CaseCustomsID", _) => (k, faker.idNumber().valid())
  ...
  private def anonymizeTblImages(data: Map[String, String]): Map[String, String] = data.map {
    ...
    case (k @ "DeletingUserID", _) => (k, faker.idNumber().valid())
